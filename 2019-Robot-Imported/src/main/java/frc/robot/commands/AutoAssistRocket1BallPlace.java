...
public class AutoAssistRocket1BallPlace extends CommandGroup {
  /**
   * Add your docs here.
   */
  public AutoAssistRocket1BallPlace() {
    ...
    addSequential(new ArmToPositionCommand(RobotMap.rocket1BallRevs));
